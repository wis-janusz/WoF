...
app.layout = html.Div([
    ...
    html.Hr(),
    dash_table.DataTable(in_projects.to_dict('records'), [{"name": i, "id":i} for i in in_projects.columns], editable=True, id = "displayed-table", persistence=True, persisted_props=["data"]),
...
#         Input(component_id="displayed-table", component_property="data")
# )
...
@callback(
    ...
    State(component_id='displayed-table', component_property='data'),
